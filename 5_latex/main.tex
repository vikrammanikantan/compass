...
\item ... etc.
\end{itemize}
Read through these. Try making changes. Try uploading your own figure and replacing the default one. The best way to learn \LaTeX{} is to tinker with it!

Another way, is to use the internet. Searching will bring up many helpful forum posts and tutorials on \LaTeX{}. There's a good chance you will find yourself back at Overleaf, because in addition to providing a document editing and collaboration system, Overleaf also provides some of the best \LaTeX{} documentation around!

If you have any notes on you, look through them for mathematical symbols. Can you add any of the equations you see to the document? This document lists many useful mathematical symbols and how to write them in \LaTeX{}: \url{http://tug.ctan.org/info/undergradmath/undergradmath.pdf}. If you can't find what you're looking for there, do a web search or try this handy website: \url{https://detexify.kirelabs.org}
...
\item Get rid of the section numbers.
